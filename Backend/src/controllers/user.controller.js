  ...
  try {
    ...
    try {
      ...
      if (user) {
        ...
        const message = `Thanks for registering on Cartify. Your OTP is ${OTP}`
        const text = ` Thanks for registering on Cartify. If you did not request this, please ignore this email.`
